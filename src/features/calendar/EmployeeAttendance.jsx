                        ...
                        <Flex vertical>
                            <div className="flex items-center justify-between">
                                <Space size="small">
                                    ...
                                    <div>
                                        <h1 className="lg:text-lg! font-semibold! md:text-md">
                                            Myo Myo
                                        </h1>
                    ...
                    <div className="border-2 border-primary rounded-2xl px-5 py-2">
                        <Flex vertical>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-3 h-3 rounded-full bg-yellow-300 border-yellow-500 border" />
                            </div>
                        </Flex>
                    </div>
                </section>
                    ...
                    <div className="border-2 border-primary rounded-2xl px-5 py-2">
                        <Flex vertical>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-3 h-3 rounded-full bg-red-300 border-red-500 border" />
                            </div>
                        </Flex>
                    </div>
                </section>
