...
const UserDetailModal = ({ viewModalOpen, onClose, selectedCustomer }) => {
    ...
    return (
        ...
        >
            <section>
                ...
                <div className="customer-grid-wrapper my-10">
                ...
                >
                    ...
                    <Button className="bg-red-500! text-lg! text-white! rounded-xl! p-6! hover:bg-red-800!">
                        Block
                    </Button>
                </Flex>
            </section>
